...
class AOT(nn.Module):
    ...
    def LSTT_forward(self,
                     curr_embs, # [[1, 24, 121, 213], [1, 32, 61, 107], [1, 96, 31, 54], [1, 256, 31, 54]]
                     long_term_memories,
                     short_term_memories,
                     curr_id_emb=None,
                     pos_emb=None,
        ...
        lstt_embs, lstt_memories, att_maps = self.LSTT(curr_emb, long_term_memories,
                                             short_term_memories, curr_id_emb,
                                             pos_emb, size_2d)
        lstt_curr_memories, lstt_long_memories, lstt_short_memories = zip(
            *lstt_memories)
        # lstt_embs [[1674, 1, 512]]
        # lstt_curr_memories [[[1674, 1, 128], [1674, 1, 512]]]
        # lstt_long_memories [[[1674, 1, 128], [1674, 1, 512], [1674, 1, 512]]]
        # lstt_short_memories [[[1, 128, 31, 54], [1, 512, 31, 54], [1, 512, 31, 54]]]
        return lstt_embs, lstt_curr_memories, lstt_long_memories, lstt_short_memories, att_maps
